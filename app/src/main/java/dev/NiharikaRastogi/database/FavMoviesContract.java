package dev.NiharikaRastogi.database;
...
/**
 * Created by Niharika Rastogi on 07-02-2016.
 */
public class FavMoviesContract {

    public static final String PROVIDER_NAME = "dev.NiharikaRastogi.FavoriteMovies";
